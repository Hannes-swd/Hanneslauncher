  ...
  return [
    ...
    SettingsEntry(
      ...
      keywords: const [
        ...
        'alphabetisch', 'alphabetical', 'neueste', 'newest', 'anordnung',
        'layout', 'spalte', 'spalten', 'column', 'columns', 'einspaltig',
        'untereinander', 'scrollen', 'scroll', 'scrollbar', 'linkshänder',
        'linkshaender', 'linkshand', 'rechtshänder', 'rechtshaender', 'hand',
        'bedienhand', 'left-handed', 'left handed', 'right-handed', 'links',
        'rechts', 'left', 'right', 'seite', 'side', 'spiegeln', 'gespiegelt',
        'umgekehrt', 'alphabet', 'buchstaben', 'letters', 'ausblenden',
